...
- **WHEN** executar `npm create vite@latest backoffice-frontend -- --template react-ts`
- **THEN** o diretorio `backoffice-frontend/` contem `package.json`, `vite.config.ts`, `tsconfig.json` e `src/main.tsx`
