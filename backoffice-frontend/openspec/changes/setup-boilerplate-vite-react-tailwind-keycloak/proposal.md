...
O projeto `backoffice-frontend/` ainda nao possui codigo. Precisamos criar a base do projeto (boilerplate) com Vite + React + TypeScript + TailwindCSS e integrar a autenticacao via Keycloak. Sem essa fundacao, nenhuma feature pode ser desenvolvida. Esta e a etapa 1 e 2 da ordem de implementacao definida no CLAUDE.md.
...
- **Codigo**: Cria toda a estrutura base em `backoffice-frontend/src/`
